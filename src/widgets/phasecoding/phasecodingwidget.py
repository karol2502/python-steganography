...
from modules.phasecoding import encode_phase_coding, decode_phase_coding
from utils.appstate import AppState

BUTTON_WIDTH = 200
BUTTON_STYLES = "margin: 40px 0; height: 40px"

class PhaseCodingWidget(QWidget):
    ...
    def __init__(self):
        ...
        self.header_lbl = QLabel("Phase coding")
    ...
    def encode(self):
        encode_phase_coding(self.file_to_encode, self.message_text_file, self.encoded_file)

    def decode(self):
        decode_phase_coding(self.file_to_decode, self.file_to_save)